    ...
    <section className="flex justify-center items-center py-6 font-sans bg-light-bg-2 bg-gradient-to-b from-[#3D7D40] to-[#fdfdfd] md:mb-24">
      <div className="flex justify-center items-center flex-col bg-[#F8F8F8] mx-5 rounded-lg px-5 py-12 md:py-20 md:px-36 md:max-w-6xl">
        ...
        <p className='mb-8 text-disabled-text leading-[34.1px] text-xl text-left md:text-center mt-4'>
          Buscamos nuevos mercados para vender nuestros productos, en los que se
          encuentran pulpa congelada de PFNMB, como es Asaí (Euterpe Precatoria)
          Moriche (Maurutia Fleuxosa) y Seje (Oenocarpus Bataua) y liofilizado
          de asai, productos transformados y muchos otros más productos
          Amazónicos. También buscamos donaciones y proyectos para consolidar
          nuestra asociación.
        </p>
        <button
