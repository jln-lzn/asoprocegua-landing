...
const Apoyar = () => {
  ...
  return (
    <section className="flex justify-center items-center py-6 font-sans bg-light-bg-2 bg-gradient-to-b from-[#3D7D40] to-[#fdfdfd]">
      <div className="flex justify-center items-center flex-col bg-[#F8F8F8] mx-5 rounded-lg px-5 py-12 md:pt-20 md:px-36 md:max-w-6xl">
        ...
        <p className="mb-8 text-disabled-text leading-[25.04px] text-xl text-left md:text-center mt-4">
